...
echo "$($PSQL "SELECT name FROM teams FULL OUTER JOIN games ON teams.team_id = games.winner_id OR teams.team_id = games.opponent_id WHERE round='Eighth-Final' AND year = 2014 ORDER BY name ASC")"
